...
function AddToList(int idx)
{
    ...
    else
    {
        ...
        else
        {
            ...
            Record.LVDataList[2].szTexture = GetClanClassIconCustom(m_memberList[0].m_array[i].ClassID);
    ...
    while(i < m_memberList[idx].m_array.Length)
    {
        ...
        Record.LVDataList[2].szTexture = GetClanClassIconCustom(m_memberList[idx].m_array[i].ClassID);
        Record.LVDataList[2].nTextureWidth = 16;
        Record.LVDataList[2].nTextureHeight = 16;
        Record.LVDataList[3].nTextureWidth = 31;
        Record.LVDataList[3].nTextureHeight = 11;
