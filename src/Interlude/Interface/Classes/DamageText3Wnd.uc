class DamageText3Wnd extends SublimityItem;
...
function OnLoad()
{
    ...
    while(i <= 30)
    {
        ...
        while(ii < 10)
        {
            m_Digits[C + ii] = TextureHandle(GetHandle(((("DamageText3Wnd.DamageText3" $ string(i)) $ "Wnd.Digit") $ string(i)) $ string(ii + 1)));
            ++ii;
        }
        ++i;
    }
...
function HandleRestart()
{
    ...
    while(i <= 30)
    {
        HideWindow(("DamageText3Wnd.DamageText3" $ string(i)) $ "Wnd");
        ++i;
    }
    return;
}
...
function ShowIndicator(int Type, int Value, int nGroupThreshold, bool bGrouped)
{
    ...
    if(nGroupThreshold > 0)
    {
        ...
        Class'NWindow.UIAPI_WINDOW'.static.KillUITimer("DamageText3Wnd", -1 * Type);
        Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText3Wnd", -1 * Type, nGroupThreshold);        
    }
    else
    {
        m_LastUsedContainer++;
...
function ShowAndAnimate(int Type, int Container, int Value, bool bGrouped)
{
    ...
    Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText3Wnd", Container, 100);
    return;
}
...
function OnTimer(int Container)
{
    ...
    if(Container > 0)
    {
        ...
        {
            Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText3Wnd", -100 * Container, 100);            
        }
        else
        {
            Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText3Wnd", -100 * Container, 100);
...
function TimerFadeOut(int Container, int Duration, int Steps)
{
    ...
    while(i <= Steps)
    {
        Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText3Wnd", (-100 * Container) - (100 - (i * C)), i * D);
        i++;
    }
    return;
}
