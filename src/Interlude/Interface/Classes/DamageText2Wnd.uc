class DamageText2Wnd extends SublimityItem;
...
function OnLoad()
{
    ...
    if(i <= 30)
    {
        ...
        if(ii < 10)
        {
            m_Digits[C + ii] = TextureHandle(GetHandle(((("DamageText2Wnd.DamageText2" $ string(i)) $ "Wnd.Digit") $ string(i)) $ string(ii + 1)));
            ++ii;
            // [Loop Continue]
            goto J0x28B;
        }
...
function HandleRestart()
{
    ...
    if(i <= 30)
    {
        HideWindow(("DamageText2Wnd.DamageText2" $ string(i)) $ "Wnd");
        ++i;
        // [Loop Continue]
        goto J0x07;
    }
...
function ShowAndAnimate(int Type, int Container, int Value, bool bGrouped)
{
    ...
    WindowName = ("DamageText2Wnd.DamageText2" $ string(Container)) $ "Wnd";
    Class'NWindow.UIAPI_WINDOW'.static.KillUITimer("DamageText2Wnd", Container);
    Class'NWindow.UIAPI_WINDOW'.static.KillUITimer("DamageText2Wnd", -100 * Container);
    ...
    Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText2Wnd", Container, 100);
    return;
}
...
function OnTimer(int Container)
{
    ...
    if(Container > 0)
    {
        ...
        {
            Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText2Wnd", -100 * Container, 100);            
        }
        else
        {
            Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText2Wnd", -100 * Container, 100);
...
function TimerFadeOut(int Container, int Duration, int Steps)
{
    ...
    if(i <= Steps)
    {
        Class'NWindow.UIAPI_WINDOW'.static.SetUITimer("DamageText2Wnd", (-100 * Container) - (100 - (i * C)), i * D);
        i++;
        // [Loop Continue]
        goto J0x28;
    }
